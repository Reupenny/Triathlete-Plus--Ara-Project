...
export class CyclingSession extends TrainingSession {
    ...
    constructor(date, notes, distance, duration, terrain, bikeUsed, airTempiture, weatherCondition) {
    ...
    getDetails() {
        return `${super.getDetails()}, Distance: ${this.distance} km, Duration: ${this.duration} mins, Terrain: ${this.terrain}, Bike: ${this.bikeUsed}, Air Temp: ${this.airTempiture}, Weather: ${this.weatherCondition}`;
    }
}